...
|   |   |   |-- components/               # ProjectLibraryPanel popup avec import fichier/URL IA, suppression/playlists/classement local/projet, AggregatorPanel sans assistant IA permanent, AiMusicImportAssistant reutilise en modale/import bibliotheque, Search provider-specifique API-only, results/rows/player, dossier local et droits/licences
