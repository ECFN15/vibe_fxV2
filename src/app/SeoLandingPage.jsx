      ...
      <div className="vf-route-stage" aria-label="Animation du pipeline Vibe_fx vers le site, Instagram et Facebook">
        <svg className="vf-route-svg" viewBox="0 0 720 420" preserveAspectRatio="none" aria-hidden="true" focusable="false">
          <defs>
            ...
            <linearGradient id="vf-route-gradient" gradientUnits="userSpaceOnUse" x1="250" x2="526" y1="210" y2="210">
              <stop offset="0%" stopColor="#2384ff" stopOpacity="1" />
              <stop offset="16%" stopColor="#43aaff" stopOpacity=".88" />
              <stop offset="42%" stopColor="#93b8d8" stopOpacity=".42" />
              <stop offset="72%" stopColor="#b9c4d2" stopOpacity=".16" />
          ...
          >
            ...
            <path d={oauthRoute.path} className="vf-route-line vf-route-line--active" filter="url(#vf-route-glow)" pathLength="1" />
          </g>
          ...
          {publicationRoutes.map((route, index) => (
            ...
            >
              ...
              <path d={route.path} className="vf-route-line vf-route-line--active" filter="url(#vf-route-glow)" pathLength="1" />
            </g>
          ))}
        </svg>
