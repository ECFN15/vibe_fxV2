...
const SCREEN_X = 10;
const SCREEN_Y = 10;
const SCREEN_WIDTH = 413;
const SCREEN_HEIGHT = 862;
const SCREEN_RADIUS = 62;
...
export function Iphone({
    ...
    const SCREEN_MAX_X = SCREEN_X + SCREEN_WIDTH;
    const SCREEN_MAX_Y = SCREEN_Y + SCREEN_HEIGHT;
    const CORNER_OFFSET = SCREEN_RADIUS * 0.5;
